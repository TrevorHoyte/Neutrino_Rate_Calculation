...
#choose the Boron 8 spectum and choose which model you would like to use in the function doAll(B8,model)
#prints rates for whichever combo
print(" rate from nominal B8 and new model",doAll("Nominal_B8","new"))
print(" rate from nominal B8 and old model",doAll("Nominal_B8","old"))
print()
#all new model
print(" rate from max B8 and new GT model",doAll("max","new"))
print(" rate from min B8 and new GT model",doAll("min","new"))
print()
print(" rate from +3sigma B8 and new GT model",doAll("spectrumhigh_B8","new"))
print(" rate from -3sigma B8 and new GT model",doAll("spectrumlow_B8","new"))
###################            END         #########################################
